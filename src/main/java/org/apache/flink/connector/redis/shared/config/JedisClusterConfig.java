...
public class JedisClusterConfig extends JedisConfig {
     ...
     */
    private JedisClusterConfig(Set<InetSocketAddress> nodes, int connectionTimeout, int maxRedirections,
    ...
    public static class Builder {
        ...
        public JedisClusterConfig build() {
            return new JedisClusterConfig(nodes, timeout, maxRedirections, maxTotal, maxIdle, minIdle, password, testOnBorrow, testOnReturn, testWhileIdle);
        }
    }
}
